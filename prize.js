        ...
        <div id="ww">
          <div class="_winwin">
            <div class="prize-line">
              ...
              <div class="label2x">Monthly Prize</div>
            </div>
            <div class="more-info">
              ...
              <a class="linkToClick" href="https://za.gl/pages/monthly-progressive-contest?reff=`+reff+`" ontouchstart="document.getElementsByClassName('linkToClick')[0].click();">Contest rules</a>
            </div>
          </div>
